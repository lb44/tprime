...
def create9():
    ...
    screen3.title('lll')
    screen3.geometry('1500x770')
    Label(screen3, text='LI',bg="lightblue",font='15',fg="BLACK",width=640).pack()        
...
def func51():
    ...
    sbmibtn = Button(screen3, text='APRIL',command=create9,fg='black',font=('Arial',9),activebackground='palegreen',width=30,border=0).place(y=170)
    sbmibtn2 = Button(screen3, text='MAY',command=create9,fg='black',font=('Arial',9),activebackground='palegreen',width=30,border=0).place(y=200)
    sbmibtn12 = Button(screen3, text='MARCH', command=create9, fg='black',font=('Arial',9),activebackground='palegreen', width=30, border=0).place(y=500)
    frame61 = Frame(screen2, bg="lightblue", width=180, height=790)
    frame61.place(x=1400, y=0)
    date = Button(frame61, text="Date", width=14, fg="black", font=(
    "timesnewroman",9), activebackground="palegreen", activeforeground="red")
    date.place(x=8, y=25)
    company = Button(frame61, text="Company", width=14, fg="black", font=(
    "timesnewroman", 9), activebackground="palegreen", activeforeground="red").place(x=8, y=60)
    back = Button(frame61, text="back", width=14, fg="black", font=(
    "timesnewroman", 9), activebackground="palegreen", activeforeground="red").place(x=8, y=700)
    Label(screen3, text='RECEIPT REGISTER',bg="lightblue",font='17',fg="black",width=430).pack()  
